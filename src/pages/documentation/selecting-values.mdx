...
<Note>
    **Enabling the 'Maintain Pick Count' feature:**
    ...
    - First, enable **Advanced Drawer Options** in the RNGNeeds Preferences window, which will allow you to set Maintain Pick Count in the **PICK** section of the drawer.
    - Alternatively, you can set `myProbabilityList.MaintainPickCountIfDisabled` to true in code.
</Note>

...
import {PreferencesPage, ExamplesTreasureChestPage, PickHistoryPage} from "@/components/PageLinks";
...
<a href={ExamplesTreasureChestPage.Link}>{ExamplesTreasureChestPage.Title}</a> sample for ideas on how to create a modular and easy-to-maintain selection systems.

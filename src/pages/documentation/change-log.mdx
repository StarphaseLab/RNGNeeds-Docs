...
**Value picks** - collection of methods and their overloads that pick values from lists within the collection:
- `List<T> PickFromList(int index)`
- `bool PickFromList(int index, out List<T> values)`
- `bool PickFromList(int index, List<T> listToFill)`
- `List<T> PickFromList(string name)`
- `bool PickFromList(string name, out List<T> values)`
- `bool PickFromList(string name, List<T> listToFill)`

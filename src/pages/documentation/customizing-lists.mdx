...
export const description =
    'Customize the appearance and behavior of RNGNeeds Probability Lists in the Unity Inspector — color palettes, drawer options, and provider interface extensions.'

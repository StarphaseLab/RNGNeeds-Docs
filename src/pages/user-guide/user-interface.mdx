...
<Note>
    If the scroll direction feels unintuitive (for example on Mac OS with 'natural' setting on), you can reverse it. Visit the [Preferences Section](/preferences) to learn more about additional and advanced options.
</Note>

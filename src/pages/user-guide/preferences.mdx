...
export const description =
  'Customize the RNGNeeds Unity Inspector experience. Configure drawer interaction, button display, scroll direction, and theme preferences for your workflow.'

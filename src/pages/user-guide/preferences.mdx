...
<Note>
    To open RNGNeeds Preferences Window, click on the **Editor Menu Bar &raquo; Edit &raquo; Preferences**. In the window that appears, click on **RNGNeeds** in the left section.
</Note>

...
import {ASSET_STORE_RNGNEEDS_LINK, DISCORD_LINK} from "@/components/RLinks";
...
<div className="not-prose mb-1 mt-6 flex gap-3 flex-wrap">
    <Button href={ASSET_STORE_RNGNEEDS_LINK} target="_blank" rel="noopener noreferrer" arrow="right" children="Get the Plugin from Asset Store" />

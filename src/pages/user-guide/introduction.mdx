...
export const description = 'RNGNeeds is a Unity plugin for probability distribution — design weighted loot tables, dice rolls, monster spawns, and item drops with a visual inspector.'
